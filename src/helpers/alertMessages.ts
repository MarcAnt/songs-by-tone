export const ALERT_MESSAGES = {
  ...
  maxLength: "Máximo de 50 caracteres para el nombre",
  minLength: "Mínimo de 4 caracteres para el nombre",
  similarName: "Agrega un nombre distinto",
  noConnection:
    "Problemas al conectar con el servidor. Recarga para agregar una nueva canción",
};
